  ...
  checkAnimationPhase() {
    if (
      ...
      this.ball.position.x =
        ...
        this.sideWallWidth / 2 +
        this.ballRadius * Math.sin(this.theta1);
      this.animationPhase = 2;
    } else if (
      this.animationPhase === 2 &&
      this.ball.position.y <=
        this.xBox.position.y + this.turnHeight / 2 + this.ballRadius
    ) {
      ...
      this.animationPhase === 3 &&
      this.ball.position.x >=
        this.sideWall3.position.x - this.sideWallWidth / 2 - this.ballRadius
    ) {
      this.ballSpeedVector.set(-this.ballSpeedVector.x, 0, 0);
      ...
      this.ball.position.z >=
        this.sideWall3.position.z + this.planeWidth / 2 + this.ballRadius
    ) {
      this.ballSpeedVector.set(0, 0, 0);
      this.ball.position.z =
        this.sideWall3.position.z +
        this.planeWidth / 2 +
        this.ballRadius * Math.sin(this.theta2);
      ...
      this.ball.position.z =
        this.zWedge.position.z + this.zSlantLen / 2 + this.ballRadius;
      this.ball.position.y =
        this.xBox.position.y - this.turnHeight / 2 + this.ballRadius;
